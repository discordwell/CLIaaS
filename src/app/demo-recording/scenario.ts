...
export const scenario: ScenarioStep[] = [
  ...
  { type: 'pause', ms: 400 },
  {
    ...
    lines: [
      ...
      { text: '  Claude Code will auto-connect to all 18 MCP tools' },
  ...
  { type: 'pause', ms: 400 },
  {
    ...
    lines: [
      ...
      { text: '  ● Bash(cliaas setup init)', className: 'text-zinc-500' },
  ...
  { type: 'pause', ms: 400 },
  {
    ...
    lines: [
      { text: '' },
      { text: '  ● Bash(cliaas sync pull zendesk --full)', className: 'text-zinc-500' },
