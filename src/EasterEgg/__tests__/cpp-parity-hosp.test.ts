...
// on destruction (C++ parity). No warhead damage is dealt to entities. HOSP has no barrel, so it uses
// the non-barrel radial path.

describe('HOSP destruction blast -- visual-only (C++ parity: no entity damage)', () => {
