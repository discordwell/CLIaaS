...
const EXPECTED_ITEMS: {
  ...
  { type: 'MECH', cost: 950, buildTime: 70, prerequisite: 'TENT', faction: 'allied', techLevel: 7, techPrereq: 'FIX' },
  { type: 'STNK', cost: 800, buildTime: 160, prerequisite: 'WEAP', faction: 'both', techLevel: -1, techPrereq: 'ATEK' },
  { type: 'CTNK', cost: 2400, buildTime: 180, prerequisite: 'WEAP', faction: 'allied', techLevel: 12, techPrereq: 'ATEK' },
  { type: 'TTNK', cost: 1500, buildTime: 200, prerequisite: 'WEAP', faction: 'soviet', techLevel: 8, techPrereq: 'TSLA' },
  { type: 'E7', cost: 1200, buildTime: 120, prerequisite: 'TENT', faction: 'both', techLevel: 11, techPrereq: 'ATEK' },
  ...
  { type: 'MSUB', cost: 1650, buildTime: 200, prerequisite: 'SPEN', faction: 'soviet', techLevel: 9, techPrereq: 'STEK' },
  // Aircraft (from HPAD/AFLD)
  { type: 'TRAN', cost: 1200, buildTime: 120, prerequisite: 'HPAD', faction: 'soviet', techLevel: 11 },
  { type: 'HELI', cost: 1200, buildTime: 200, prerequisite: 'HPAD', faction: 'allied', techLevel: 9 },
  { type: 'HIND', cost: 1200, buildTime: 180, prerequisite: 'HPAD', faction: 'soviet', techLevel: 9 },
  { type: 'MIG', cost: 1200, buildTime: 180, prerequisite: 'AFLD', faction: 'soviet', techLevel: 10 },
  { type: 'YAK', cost: 800, buildTime: 120, prerequisite: 'AFLD', faction: 'soviet', techLevel: 5 },
  ...
  { type: 'MSLO', cost: 2500, buildTime: 280, prerequisite: 'STEK', faction: 'both', techLevel: 13, isStructure: true },
  // Walls
