...
const EXPECTED_ITEMS: {
  ...
  { type: 'APC', cost: 800, buildTime: cppBuildTime(800), prerequisite: 'WEAP', faction: 'allied', techLevel: 5, techPrereq: 'BARR' },
  ...
  { type: 'BARR', cost: 300, buildTime: cppBuildTime(300), prerequisite: 'POWR', faction: 'allied', techLevel: 1, isStructure: true },
  { type: 'TENT', cost: 300, buildTime: cppBuildTime(300), prerequisite: 'POWR', faction: 'soviet', techLevel: 1, isStructure: true },
  ...
  // Structures — defenses
  { type: 'PBOX', cost: 400, buildTime: cppBuildTime(400), prerequisite: 'BARR', faction: 'allied', techLevel: 2, isStructure: true },
  { type: 'HBOX', cost: 600, buildTime: cppBuildTime(600), prerequisite: 'BARR', faction: 'allied', techLevel: 3, isStructure: true },
  { type: 'GUN', cost: 600, buildTime: cppBuildTime(600), prerequisite: 'BARR', faction: 'allied', techLevel: 4, isStructure: true },
  ...
  { type: 'FTUR', cost: 600, buildTime: cppBuildTime(600), prerequisite: 'TENT', faction: 'soviet', techLevel: 2, isStructure: true },
  ...
  { type: 'KENN', cost: 200, buildTime: cppBuildTime(200), prerequisite: 'TENT', faction: 'soviet', techLevel: 3, isStructure: true },
  // Structures — naval
