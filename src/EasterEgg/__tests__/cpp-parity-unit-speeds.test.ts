...
const SPEED_CLASSES: [string, SpeedClass, string][] = [
  ...
  // Vehicles = WHEEL (C++ udata.cpp:865 forces all to WHEEL even if tracked)
  ['1TNK', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['2TNK', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['3TNK', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['4TNK', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['JEEP', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['APC',  SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['ARTY', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['HARV', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['MCV',  SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['TRUK', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['V2RL', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['MNLY', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['MRJ',  SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['MGG',  SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['STNK', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['CTNK', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['TTNK', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['DTRK', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
  ['QTNK', SpeedClass.WHEEL,  'udata.cpp:865 forces all vehicles to WHEEL'],
