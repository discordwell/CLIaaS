/**
 * Red Alert tutorial/trigger message text.
 *
 * C++ loads this table from TUTORIAL.INI during Init_Game().
 * taction.cpp indexes TutorialTextOffsets[Data.Value] for TACTION_TEXT_TRIGGER.
 */

export const RA_MESSAGE_DELAY_TICKS = 540; // Rule.MessageDelay (.6 minutes) * 15 FPS * 60 seconds
...
export function getTutorialText(id: number): string | undefined {
  return (TUTORIAL_TEXT as Record<number, string | undefined>)[id];
}
