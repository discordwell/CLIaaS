...
class TeamClass : public AbstractClass
{
	public:
		...
		*/
		...
		// Agent harness accessors — expose private state for TS parity probing
		int Get_Current_Mission(void) const {return CurrentMission;}
		int Get_Time_Out(void) const {return (int)TimeOut.Value();}
